        ...
        <tbody>
            <?php   while($row = mysqli_fetch_array($printfacture)) { ?>
                    <tr>
                        ...
                        <td>
                        <form action='facturepro.php' method='POST'>
                        <input type='hidden' value='<?= $row['id_commande'] ?>' name='id_commande'>
                            <label for='cars'>Changer de statut</label>
                                <select id='dropdownstatut' name='dropdownstatut'>
                                    <option value='<?= $row['statutcommande'] ?>'><?= $row['statutcommande'] ?></option>
                            ...
                            <input type='hidden' value='<?= $row['id_commande'] ?> ' name='iddelacommande'>
                            <input name='updatestatut' type='submit'>
                        </form>
                        </td>
                    </tr>
            <?php } ?>
